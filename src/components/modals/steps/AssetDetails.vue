...
const removeAppliancePhoto = (assetId, index) => {
  URL.revokeObjectURL(assetPhotos.value[assetId][index].previewUrl)
  ...
  <div>
    <div class="mb-8">
      ...
      <p class="mt-1 text-sm text-gray-500 mb-4">
        Upload photos of your home's key systems to help us provide personalized energy-saving recommendations.
      </p>
