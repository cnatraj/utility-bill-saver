  ...
  <div>
    ...
    <template v-else>
      ...
      <div class="mb-8">
        ...
        <p class="text-gray-600 mt-2">Here's your energy saving progress at a glance.</p>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="card p-6">
          <div class="flex items-center">
            ...
            <div>
              ...
              <p class="text-2xl font-bold text-gray-900">{{ billStore.totalEnergyUsage }} kWh</p>
            </div>
          </div>
        </div>
        ...
        <div class="card p-6">
          <div class="flex items-center">
            <div class="p-3 rounded-md bg-secondary-100 text-secondary-700 mr-4">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
              ...
              <p class="text-2xl font-bold text-gray-900">${{ billStore.totalCost.toFixed(2) }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="card p-6">
          <div class="flex items-center">
            ...
            <div>
              ...
              <p class="text-2xl font-bold text-gray-900">${{ recommendationStore.totalEstimatedSavings.toFixed(2) }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="card p-6">
          <div class="flex items-center">
            ...
            <div>
              ...
              <p class="text-2xl font-bold text-gray-900">${{ recommendationStore.realizedSavings.toFixed(2) }}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card p-6 mb-8">
        <h2 class="text-lg font-bold text-gray-900 mb-4">Your Savings Progress</h2>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        <!-- Energy usage chart -->
        <div class="card p-6">
          <h2 class="text-lg font-bold text-gray-900 mb-4">Energy Usage (Last 6 Months)</h2>
          <div class="h-64">
            <!-- Chart would go here in a real implementation -->
            <div class="bg-gray-100 h-full rounded-md flex items-center justify-center">
        ...
        <!-- Billing chart -->
        <div class="card p-6">
          <h2 class="text-lg font-bold text-gray-900 mb-4">Bills (Last 6 Months)</h2>
          <div class="h-64">
            <!-- Chart would go here in a real implementation -->
            <div class="bg-gray-100 h-full rounded-md flex items-center justify-center">
      ...
      <div class="card p-6">
        <div class="flex justify-between items-center mb-4">
          ...
          <router-link to="/recommendations" class="text-sm text-primary-600 hover:text-primary-500">
            View all
          </router-link>
        </div>
        ...
        <div v-if="quickRecommendations.length > 0" class="space-y-4">
          ...
          >
            <div class="flex items-start">
              <div class="rounded-full p-2 bg-primary-100 text-primary-700 mr-3">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  <path fill-rule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z" clip-rule="evenodd" />
                </svg>
              </div>
              <div class="flex-1">
                <h3 class="font-bold text-gray-900">{{ recommendation.title }}</h3>
                <p class="text-gray-600 text-sm mt-1">{{ recommendation.description }}</p>
                
                <div class="flex flex-wrap items-center mt-3 text-sm">
                  <span class="bg-primary-100 text-primary-800 px-2 py-1 rounded-md text-xs font-medium mr-2">
                    Save ~${{ recommendation.estimatedSavings.toFixed(2) }}
                  </span>
                  <span class="bg-gray-100 text-gray-800 px-2 py-1 rounded-md text-xs font-medium mr-2">
        ...
        <div v-else class="text-center py-8">
          ...
          <p class="text-sm text-gray-500 mt-1">Upload your utility bills to get personalized recommendations.</p>
          <router-link to="/bill-analysis" class="btn-primary inline-block mt-4">
            Upload Bills
          </router-link>
        </div>
      </div>
